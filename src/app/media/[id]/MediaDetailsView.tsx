  ...
  return (
    <div className="space-y-12">
      ...
      <div className="mx-auto max-w-[1600px] space-y-12 px-4 pb-12 sm:px-6 lg:px-8">
        <section id="more-info" className="scroll-mt-32 space-y-3 rounded-3xl border border-(--border) bg-(--surface) p-6 shadow-[0_20px_60px_rgba(0,0,0,0.18)] sm:p-8">
        ...
        <section className="rounded-3xl border border-(--border) bg-(--surface) p-6 shadow-[0_20px_60px_rgba(0,0,0,0.18)] sm:p-8">
          <CastStrip cast={item.cast ?? []} />
        </section>

        {isSeries ? (
          <section id="episodes" className="rounded-3xl border border-(--border) bg-(--surface) p-6 shadow-[0_20px_60px_rgba(0,0,0,0.18)] sm:p-8">
            <EpisodePreview
              episodes={episodes}
